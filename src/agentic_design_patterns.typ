...
//
// - excercises: HITL (before code execution)
// - excercises: implement planning pattern
// - excercises: customize plan interactively
//
// - data analysis agent with memory
//   - remember findings across conversations?
...
#slide[
  ...
  #side-by-side(gutter: 3mm, columns: (1.5fr, 2fr))[
    ...
    //     }
    //   }
    //   content((0, 0), [Agent], frame: "circle", padding: 1em, name: "agent")
    //   content((8, 0), [Environment], frame: "circle", padding: 1em, name: "env")
    //   bent-arrow("agent", "env", label: [Action], bend: 1.5, a-anc: "north-east", b-anc: "north-west")
    //   bent-arrow("env", "agent", label: [Observation], bend: -1.5, a-anc: "south-west", b-anc: "south-east")
    // })
...
#slide[
  #title[Agentic Design Patterns: self-improvement]
...
#slide[
  ...
  - let's look at more design patterns: see https://google.github.io/adk-docs/agents/multi-agents/#combining-patterns
  - code execution
  - reflexion
  - how to evaluate?
]
